...
static void cbComboSelect(Widget ww,XtPointer userdata,XtPointer data) {
  ...
  if (newspecidx<0) {
    wxyz[0]=specL[specidx].m_value.w();
    wxyz[1]=specL[specidx].m_value.x();
    wxyz[2]=specL[specidx].m_value.y();
    wxyz[3]=specL[specidx].m_value.z();
  }
  else {
...
void createLightDialog(Widget parent,int lightidx) {
  ...
  if (lightspec) {
    XtSetArg(xxargs[0],XmNposition,(int)(simplepow10[spin_dec_off]*lightspec->m_value.w()));
  ...
  if (lightspec) {
    XtSetArg(xxargs[0],XmNposition,(int)(simplepow10[spin_dec_off]*lightspec->m_value.x()));
  ...
  if (lightspec) {
    XtSetArg(xxargs[0],XmNposition,(int)(simplepow10[spin_dec_off]*lightspec->m_value.y()));
  ...
  if (lightspec) {
    XtSetArg(xxargs[0],XmNposition,(int)(simplepow10[spin_dec_off]*lightspec->m_value.z()));
