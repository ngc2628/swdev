...
all: $(OBJPRJ) $(TARGET)
	cd $(CVER)/ipc/server; make -f Makefile.gnu
	cd $(CVER)/ipc/client; make -f Makefile.gnu
	cd $(CVER)/ipc
...
clean: 
	...
	$(RM) *~ core *.core
	cd $(CVER)/ipc/server; make -f Makefile.gnu clean
	cd $(CVER)/ipc/client; make -f Makefile.gnu clean
	cd $(CVER)/ipc
