...
txtsimplei102str: function(number) {
  ...
  var ans=[];
  var sgn=(number<0 ? 1 : 0);
  if (sgn==1)
    number=-number;
  var inum=new Uint32Array([number,0]);
  do {
    inum[1]=inum[0]%10;
...
txtround: function(strnum,pos) {
  ...
  var ii=0,ll=0,llrd=snum.length,sz=qqszsgnfe[1],rdpos=pos+sz;
...
txtexp2simple: function(str) {
  ...
  var strarr=str.split('');
  var ii=0,idx=-1,dpos=-1,epos=-1,sc=0,sgn=0,ll=strarr.length,lle=0,llm=0;
  var mant=[];
  var exp=[];
  var ans=[];
  var cc=new Uint16Array([0]);
...
/*var ans=textcalc.txtcalc('*','.66','754',100);
print (new Error().lineNumber+" ["+ans+"]");

ans=textcalc.txtcalc('+','12.4','13.6',100);
print (new Error().lineNumber+" ["+ans+"]");

var qqszsgnfe=new Int32Array([0,0,0,0]);
var fmt=new Int8Array([-1,-1]);
var maxlen=500;
var snum1="32.0023456e-22";
var snum2="-0.00000737";
var snum3="127.12";
var snum4="13.";
var snum5="0xabcd";
var calctype="/";

ans=textcalc.txt2float("-9.1e1");
print (new Error().lineNumber+" ["+ans+"]");
ans=textcalc.txtsimple2exp(ans);
print (new Error().lineNumber+" ["+ans+"]");
ans=textcalc.txt2float(ans);
print (new Error().lineNumber+" ["+ans+"]");
ans=textcalc.txtexp2simple(ans);
print (new Error().lineNumber+" ["+ans+"]");

ans=textcalc.txtabs(snum4,qqszsgnfe);
print (new Error().lineNumber+" ["+ans+"] ["+
qqszsgnfe[0]+","+qqszsgnfe[1]+","+qqszsgnfe[2]+","+qqszsgnfe[3]+"]");

ans=textcalc.txt2float("e-2");
print (new Error().lineNumber+" ["+ans+"]");
ans=textcalc.txt2float(snum2);
print (new Error().lineNumber+" ["+ans+"]");

print (new Error().lineNumber+" calc ["+snum1+"] "+calctype+" ["+snum2+"]");
ans=textcalc.txtcalc(calctype,snum1,snum2,maxlen);
print (new Error().lineNumber+" ["+ans+"]");

ans=textcalc.txtround(ans,20);
print (new Error().lineNumber+" ["+ans+"]");
ans=textcalc.txtsimple2exp(ans);
print (new Error().lineNumber+" ["+ans+"]");
ans=textcalc.txtexp2simple(ans);
...
var modans=textcalc.txtmod(snum3,snum4,maxlen);
print (new Error().lineNumber+" ["+modans[0]+"] ["+modans[1]+"]");

ans=textcalc.txtchknumfmt(snum5);
print (new Error().lineNumber+" ["+ans+"]");

fmt[0]=34;
ans=textcalc.txtconvfmt(snum5,fmt,maxlen);
print (new Error().lineNumber+" ["+ans+","+fmt[0]+","+fmt[1]+"]");*/
